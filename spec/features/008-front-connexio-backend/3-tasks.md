...
[ ] T2 — `public/js/pedido.js`: cargar catálogo desde `GET /api/cookies` al iniciar (pintar tarjetas dinámicamente o sobre template). ⏳ Pendiente — el frontend sigue con catálogo estático.
